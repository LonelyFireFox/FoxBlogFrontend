  ...
  render () {
    ...
    return (
      <div className={this.props.className}>
        <h3 className={styles.title}>注册界面</h3>
        <Form onSubmit={this.registerSubmit}>
          <Form.Item help={getFieldError('registerUsername')
          && <PromptBox info={getFieldError('registerUsername')} width={calculateWidth(getFieldError('registerUsername'))}/>}>
          ...
          <div className={styles.bottom}>
            <input className={styles.loginBtn} type="submit" value='注册'/>
            <span className={styles.registerBtn}  onClick={this.gobackLogin}>返回登录</span>
          </div>
        </Form>
